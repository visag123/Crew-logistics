         ...
         if (newdata.password === password) {
           if (newdata.status === "Active") {
             if (newdata.role === "Crew Admin") {
              setUserInfo({initial:true , nameId:username, location:newdata.location})
              setCrew(true)
               setIsAuth(!isAuth)
               navigate("/admin/crew");
              ...
              setUserInfo({initial:true , nameId:username,userId:newdata.userId, location:newdata.location})
               navigate("/crewmember");
             }
